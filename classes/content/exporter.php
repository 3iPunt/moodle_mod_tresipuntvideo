 ...
 */
namespace mod_tresipuntvideo\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_tresipuntvideo.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[]  = new exportable_filearea(
            $this->get_context(),
            $this->get_component(),
            get_string('tresipuntvideocontent', 'mod_tresipuntvideo'),

            // The files held in mod_tresipuntvideo are stored in the 'content' filearea, under itemid 0.
            'content',
            0,
